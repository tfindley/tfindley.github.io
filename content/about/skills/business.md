...
description: "leadership, governance/compliance, delivery, and business/stakeholder skills"
layout: simple
...
- **Major Incident Coordinator** — led live incident response incl. emergency Compute shutdown (*VIB*)
...
- **Change management** — from first working within a peer-reviewed process (*Surrey*), to formal ITIL change control where the instincts formed (*UKCloud*), to authoring & chairing (*VIB*): *practitioner → advocate → author*
