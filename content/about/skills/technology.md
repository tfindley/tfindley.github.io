...
> - ○ Learning.
> *This rates centrality, not expertise — "Terraform is core to my work" is a fact, not a boast.*
...
- **● Proficient:** Ubiquiti UniFi *(multi-site live deployments)* · HAProxy · KeepAliveD · DNS (BIND/`named`, FreeIPA) · structured cabling, rack/patch
- **◐ Familiar:** HP ProCurve / Aruba *(dated)* · Mikrotik · OPNsense / pfSense · Netbird (mesh) · AdGuard Home
