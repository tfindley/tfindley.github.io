...
At my curent point in The Phoenix Project (Part 2), we're at the point where our protagonists are debating whether or not to launch their Monitoring Project.

This, combined with my current work generatring project documentation, got me thinking:
...
- PSU's are often installed in pairs (or sometimes more), allowing a system to run with N-1 (so long as the curent power drawer doesnt exceed C*(N-1) (where C is the capacity of a single PSU))
...
When I talk about customer satisfaction to IT peers, I'm usually met with alot of confused stares: "IT don't deal with the customers". They're external. Or from my time in Research and Education: "We don't have customers, we have students / researchers / staff".
